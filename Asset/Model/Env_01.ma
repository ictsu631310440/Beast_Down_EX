...
//Name: Env_01.ma
//Last modified: Fri, Feb 03, 2023 03:40:07 AM
//Codeset: UTF-8
requires maya "2023";
...
fileInfo "UUID" "FD696FD2-7343-9142-3BDC-E39BC1D46439";
createNode transform -s -n "persp";
	rename -uid "FB48DACA-3942-0ACD-3B12-CDAFF8FB3854";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.65037195502148 5.848917343828969 -8.8618456743839538 ;
	setAttr ".r" -type "double3" -15.938352726226405 -251.00000000001248 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D2FD03F1-6448-FF1D-A5D1-F680E7D167C4";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.632020528915676;
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape10" -p "pSphere1";
...
createNode mesh -n "pSphereShape4" -p "pSphere4";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape18" -p "pSphere4";
...
createNode mesh -n "pSphereShape5" -p "pSphere5";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape6" -p "pSphere5";
...
createNode mesh -n "pSphereShape6" -p "pSphere6";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape16" -p "pSphere6";
...
createNode mesh -n "pSphereShape7" -p "pSphere7";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape12" -p "pSphere7";
...
createNode mesh -n "pSphereShape8" -p "pSphere8";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape22" -p "pSphere8";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "20ADCDF6-3D4F-D462-45FB-91824B800468";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3EB3C8FE-A34D-AFB1-E904-6C98C9EDEE2B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "189B2B88-7144-72E3-72D4-D793AF0359FE";
createNode displayLayerManager -n "layerManager";
	rename -uid "F80F5284-8B4B-D1B0-2566-1CA6852EC325";
createNode displayLayer -n "defaultLayer";
	rename -uid "4D75EFCE-9D4E-89C4-77C5-72B1F879BABC";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4453E223-8B46-B0B5-6ED9-6A8815120271";
...
connectAttr "polyTweakUV8.out" "pCylinderShape6.i";
connectAttr "polyTweakUV8.uvtk[0]" "pCylinderShape6.uvst[0].uvtw";
connectAttr "polyTweakUV14.out" "pCubeShape13.i";
connectAttr "polyTweakUV14.uvtk[0]" "pCubeShape13.uvst[0].uvtw";
connectAttr "transferAttributes6.og[0]" "pSphereShape1.i";
connectAttr "polyTweakUV9.uvtk[0]" "pSphereShape1Orig.uvst[0].uvtw";
connectAttr "polyTweakUV9.out" "pSphereShape1Orig.i";
connectAttr "transferAttributes7.og[0]" "pSphereShape2.i";
connectAttr "polyTweakUV15.uvtk[0]" "pSphereShape2Orig.uvst[0].uvtw";
connectAttr "polyTweakUV15.out" "pSphereShape2Orig.i";
connectAttr "transferAttributes3.og[0]" "pSphereShape3.i";
connectAttr "polyTweakUV13.uvtk[0]" "pSphereShape3Orig.uvst[0].uvtw";
connectAttr "polyTweakUV13.out" "pSphereShape3Orig.i";
connectAttr "transferAttributes4.og[0]" "pSphereShape4.i";
connectAttr "polyTweakUV18.uvtk[0]" "pSphereShape4Orig.uvst[0].uvtw";
connectAttr "polyTweakUV18.out" "pSphereShape4Orig.i";
connectAttr "polyTweakUV5.out" "pSphereShape5.i";
connectAttr "polyTweakUV5.uvtk[0]" "pSphereShape5.uvst[0].uvtw";
connectAttr "transferAttributes1.og[0]" "pSphereShape6.i";
connectAttr "polyTweakUV16.uvtk[0]" "pSphereShape6Orig.uvst[0].uvtw";
connectAttr "polyTweakUV16.out" "pSphereShape6Orig.i";
connectAttr "transferAttributes2.og[0]" "pSphereShape7.i";
connectAttr "polyTweakUV11.uvtk[0]" "pSphereShape7Orig.uvst[0].uvtw";
connectAttr "polyTweakUV11.out" "pSphereShape7Orig.i";
connectAttr "transferAttributes5.og[0]" "pSphereShape8.i";
connectAttr "polyTweakUV21.uvtk[0]" "pSphereShape8Orig.uvst[0].uvtw";
connectAttr "polyTweakUV21.out" "pSphereShape8Orig.i";
...
connectAttr "|pCube10|polySurfaceShape7.o" "polyLayoutUV4.ip";
...
connectAttr "pSphereShape6Orig.w" "transferAttributes1.ip[0].ig";
connectAttr "pSphereShape5.w" "transferAttributes1.src[0]";
connectAttr "pSphereShape7Orig.w" "transferAttributes2.ip[0].ig";
connectAttr "pSphereShape5.w" "transferAttributes2.src[0]";
connectAttr "pSphereShape3Orig.w" "transferAttributes3.ip[0].ig";
connectAttr "pSphereShape7.w" "transferAttributes3.src[0]";
connectAttr "pSphereShape4Orig.w" "transferAttributes4.ip[0].ig";
connectAttr "pSphereShape3.w" "transferAttributes4.src[0]";
connectAttr "pSphereShape8Orig.w" "transferAttributes5.ip[0].ig";
connectAttr "pSphereShape4.w" "transferAttributes5.src[0]";
connectAttr "pSphereShape1Orig.w" "transferAttributes6.ip[0].ig";
connectAttr "pSphereShape8.w" "transferAttributes6.src[0]";
connectAttr "pSphereShape2Orig.w" "transferAttributes7.ip[0].ig";
connectAttr "pSphereShape1.w" "transferAttributes7.src[0]";
